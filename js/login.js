function iniciarCompra() {
    const presupuesto = document.getElementById("presupuesto").value.replace(/\D/g, "");
    ...
    if (presupuesto && cantidad > 0 && cantidad <= 20) {
        ...
        alert("Por favor, revisa que los campos de presupuesto y cantidad de artículos sean válidos.");
    }
}
